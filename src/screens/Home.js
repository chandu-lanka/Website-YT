...
const Home = () => {
  useEffect(() => {
    document.title = "Welcome to The Orange Triangle Website";
  }, []);
  return (
    <div classname="home">
      <Navbar />
      ...
      <section className="stuff">
        <div className="stuff-container">
          <Card
            img={ChooseYourEngine}
            desc="In this post I give you suggestions on which Game Engine You would use from a particular case EX:  'No coding experience, A particular programming language etc.'"
            buttonto="/tuts/choose-your-game-engine"
          ...
          <Card
            img={GodotCourse}
            desc="In this post I give you a tutorial series(not released yet) fully on godot. You'll learn about GDScript, Nodes, Scenes, Reusability of Scenes and many more."
            buttonto="/tuts/godot-course"
            buttontext="Learn More"
          />
        </div>
      </section>
